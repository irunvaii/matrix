                ...
                <div class="form-group col-md-8">
                    ...
                    <div class="selectgroup selectgroup-pills">
                        <label class="selectgroup-item">
                            ...
                            <span class="selectgroup-button selectgroup-button-icon"><i class="fa fa-fw fa-question"></i> Unpaid</span>
                        </label>
                        <label class="selectgroup-item">
                            <input type="radio" name="txstatus" value="1" class="selectgroup-input"<?php echo myvalidate($txstatus_cek[1]); ?>>
                            <span class="selectgroup-button selectgroup-button-icon"><i class="fa fa-fw fa-check"></i> Paid</span>
                        </label>
                        <label class="selectgroup-item">
                            <input type="radio" name="txstatus" value="2" class="selectgroup-input"<?php echo myvalidate($txstatus_cek[2]); ?>>
                            <span class="selectgroup-button selectgroup-button-icon"><i class="fa fa-fw fa-ban"></i> OnHold</span>
                        </label>
                        <label class="selectgroup-item">
                            <input type="radio" name="txstatus" value="3" class="selectgroup-input"<?php echo myvalidate($txstatus_cek[3]); ?>>
                            <span class="selectgroup-button selectgroup-button-icon"><i class="fa fa-fw fa-times"></i> Cancel</span>
                        </label>
                    </div>
                </div>
            </div>
