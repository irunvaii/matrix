...
if (isset($FORM['dosubmit']) and $FORM['dosubmit'] == '1') {
    ...
    if ($_FILES['flpath'] && $_FILES["flpath"]["size"] < 1100000) {
        // valid extensions
        $valid_extensions = array('zip', 'docx', '7z', 'rar', 'pdf');
        ...
        if (in_array($ext, $valid_extensions)) {
            ...
            $_SESSION['dotoaster'] = "toastr.error('File not supported <strong>Please try again!</strong>', 'Warning');";
            header('location: ' . $redirto);
            exit;
        }
    }
        ...
        <form method="post" action="doupfile.php" enctype="multipart/form-data">
            <div class="form-row">
                ...
                <div class="form-group col-md-7">
                    ...
                    <div class="form-text text-muted">The file (zip, rar, pdf) must have a maximum size of 2Mb</div>
                </div>
            </div>
