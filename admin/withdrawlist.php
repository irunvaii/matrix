            ...
            <div class="card-footer bg-whitesmoke">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div>
                            <a href="javascript:;" data-href="dowithdraw.php?redir=withdrawlist&mdlhasher=<?php echo myvalidate($mdlhasher); ?>" data-poptitle="<i class='fa fa-fw fa-check'></i> Add Withdrawal" class="openPopup btn btn-secondary"><i class="fa fa-fw fa-plus"></i> New Withdrawal</a>
                        </div>
                    </div>
                </div>
            </div>
