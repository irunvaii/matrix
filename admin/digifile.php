            ...
            <div class="card-footer bg-whitesmoke">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div>
                            <a href="javascript:;" data-href="doupfile.php?redir=digifile&mdlhasher=<?php echo myvalidate($mdlhasher); ?>" data-poptitle="<i class='fa fa-fw fa-plus'></i> Upload File" class="openPopup btn btn-secondary"><i class="fa fa-fw fa-upload"></i> Upload File</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card card-danger">
                <div class="card-header">
                    ...
                    <div class="card-header-action">
                        <a data-collapse="#blkfile-collapse" class="btn btn-icon btn-secondary" href="#"><i class="fas fa-plus"></i></a>
                    </div>
                </div>
        ...
        <table class="table table-striped table-hover">
            <thead>
                <tr>
                    ...
                    <th scope="col" class="text-right" nowrap><?php echo myvalidate($tblshort['fldlcount']); ?>Download</th>
                ...
                if (count($userData) > 0) {
                    ...
                    foreach ($userData as $val) {
                        ...
                        <tr>
                            ...
                            <td class="text-right"><span class="badge badge-light text-small"><?php echo myvalidate($val['flsize']); ?></span> x<?php echo intval($val['fldlcount']); ?></td>
                            <td align="center" nowrap>
                                <a href="javascript:;"
                                   ...
                                   data-trigger="hover"
                                   data-placement="left" 
                                   title="<?php echo myvalidate($val['flid'] . '. ' . $val['flname']); ?>"
                                ...
                                <a href="javascript:;" data-href="dosharefile.php?fileId=<?php echo myvalidate($val['flid']); ?>&redir=digifile&mdlhasher=<?php echo myvalidate($mdlhasher); ?>" data-poptitle="<i class='fa fa-fw fa-share-alt'></i> Share File Link" class="btn btn-sm btn-success openPopup" data-toggle="tooltip" title="Share File <?php echo myvalidate($val['flname']); ?>"><i class="fa fa-fw fa-share-alt"></i></a>
                                <a href="javascript:;" data-href="doupfile.php?editId=<?php echo myvalidate($val['flid']); ?>&redir=digifile&mdlhasher=<?php echo myvalidate($mdlhasher); ?>" data-poptitle="<i class='fa fa-fw fa-edit'></i> Update File Details" class="btn btn-sm btn-info openPopup" data-toggle="tooltip" title="Update <?php echo myvalidate($val['flname']); ?>"><i class="fa fa-fw fa-edit"></i></a>
                                <a href="javascript:;" data-href="doupfile.php?hash=<?php echo myvalidate($hasdel); ?>&delId=<?php echo myvalidate($val['flid']); ?>&redir=digifile&mdlhasher=<?php echo myvalidate($mdlhasher); ?>" class="btn btn-sm btn-danger bootboxconfirm" data-poptitle="File: <?php echo myvalidate($val['flid'] . '. ' . $val['flname']); ?>" data-popmsg="Are you sure want to delete this file?<br /><span class='text-danger'><em>The file will also removed from the server!</em></span>" data-toggle="tooltip" title="Delete <?php echo myvalidate($val['flname']); ?>"><i class="far fa-fw fa-trash-alt"></i></a>
                            </td>
